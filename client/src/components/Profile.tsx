...
export default function Profile() {
  ...
  const [emailConfirmationDAte] = useState<string | null>(
    JSON.parse(localStorage.getItem(import.meta.env.VITE_COOKIE) || "").user.email_confirmed_at
  );
        ...
        <div className="flex flex-col space-y-6 max-w-2xl mx-auto">
            ...
            <CardContent>
              <div className="space-y-4">
                <div className="flex items-center justify-between p-4 border rounded-lg">
                  ...
                  <Badge variant={emailConfirmationDAte === null ? "destructive" : "secondary"}>
                    {emailConfirmationDAte === null ? "Not Verified" : "Verified"}
                  </Badge>
                </div>
              </div>
            </CardContent>
          ...
          <div className="p-4 bg-muted rounded-lg">
            <p className="text-sm text-muted-foreground">
              <strong>Security tip:</strong> Use a strong password that includes a mix of letters, numbers, and special
